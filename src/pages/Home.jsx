        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6 lg:gap-12">
          ...
          <div className="flex flex-col items-center max-w-lg lg:flex-1">
            ...
            <motion.div
              ...
              className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl shadow-purple-500/40 mb-4"
            >
              <img 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              { name: 'FUN Charity', url: '#', icon: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/693845be034c36e3732b8bac/ad4f7a371_image.png', color: 'from-rose-400 to-pink-400' },
