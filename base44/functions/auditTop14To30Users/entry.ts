...
Deno.serve(async (req) => {
  try {
    ...
    console.log('🔍 Starting audit for top 14-30 users...');
    ...
    // Get users ranked 14-30
    const targetUsers = allBalances.slice(13, 30); // Index 13-29 = rank 14-30

    console.log(`📊 Auditing ${targetUsers.length} users (rank 14-30)`);
